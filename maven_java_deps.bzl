...
def __setup_bzlmodrio_photonlib_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact_sha256 = "21712eba4d1fc49db82263b781ed85f789b1e34b4136eb0e76c679c5502919f1",
    ...
    jvm_maven_import_external(
        ...
        artifact_sha256 = "fefb832c707e0dedb65b8063c0b9b6611ba2379512c464b299a890cceb39b39b",
        server_urls = ["https://maven.photonvision.org/repository/internal"],
    )
