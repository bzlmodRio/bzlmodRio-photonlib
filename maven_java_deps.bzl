...
def __setup_bzlmodrio_photonlib_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact_sha256 = "ae4a7aaba78eddd88c056e133c2df6a0ef6eaa84121928f1f65786da0c45676d",
    ...
    jvm_maven_import_external(
        ...
        artifact_sha256 = "aa73a0bb6c5df7b707f51afe6f5db68586a4c5d4059cd14bd6068aeee0c32a5d",
        server_urls = ["https://maven.photonvision.org/repository/internal"],
    )
