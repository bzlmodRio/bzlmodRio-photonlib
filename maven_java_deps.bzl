...
def __setup_bzlmodrio_photonlib_java_dependencies(mctx):
    jvm_maven_import_external(
        ...
        artifact = "org.photonvision:photonlib-java:v2024.1.4",
        artifact_sha256 = "fee0e41751fa6ca07d1b6a82f993bc1e72ddb32d33dee0df13598893230c267c",
        server_urls = ["https://maven.photonvision.org/repository/internal"],
    )
    jvm_maven_import_external(
        name = "org_photonvision_photontargeting_java",
        artifact = "org.photonvision:photontargeting-java:v2024.1.4",
        artifact_sha256 = "305cdf39674182eefbb7486afd3f70b06b14b926a5625ff39d5896fc3e9fe898",
        server_urls = ["https://maven.photonvision.org/repository/internal"],
    )
