...
def __setup_bzlmodrio_photonlib_cpp_dependencies(mctx):
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2025.0.0-beta-7/photonlib-cpp-v2025.0.0-beta-7-headers.zip",
        sha256 = "98bc5a8c9cb51c44c44decb8fd0221fcddf1b643350cd8c1f0b296123c290aaf",
        build_file_content = cc_library_headers,
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photonlib-cpp_windowsx86-64",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2025.0.0-beta-7/photonlib-cpp-v2025.0.0-beta-7-windowsx86-64.zip",
        sha256 = "ba2284f759f230a5b0d697324816c5c69ee557f90aa513490409b5e9a3ce2119",
    ...
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2025.0.0-beta-7/photonlib-cpp-v2025.0.0-beta-7-linuxx86-64.zip",
        sha256 = "2fd84468322d275cbd715df0ff1d59b8e47c4d7e3ef0f4854c15f1156222fec1",
        build_file = "@bzlmodrio-photonlib//private/cpp/photonlib-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photonlib-cpp_osxuniversal",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2025.0.0-beta-7/photonlib-cpp-v2025.0.0-beta-7-osxuniversal.zip",
        sha256 = "88bd5e81038f2f34f2258ed84283e146c39018b13c6aeba3f9e0de6d975ebdd9",
        build_file = "@bzlmodrio-photonlib//private/cpp/photonlib-cpp:shared.BUILD.bazel",
        patch_cmds = [
    ...
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2025.0.0-beta-7/photontargeting-cpp-v2025.0.0-beta-7-headers.zip",
        sha256 = "0090f0a398922dc2cb8b42563cf3fef2e6e04133f9af6eb0c463ef69bb05a0ed",
        build_file_content = cc_library_headers,
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photontargeting-cpp_windowsx86-64",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2025.0.0-beta-7/photontargeting-cpp-v2025.0.0-beta-7-windowsx86-64.zip",
        sha256 = "8928933c992163c9ab1f0bc03bfb9cd57b263e814f31091ae2e07821e5808e99",
    ...
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2025.0.0-beta-7/photontargeting-cpp-v2025.0.0-beta-7-linuxx86-64.zip",
        sha256 = "02924b825941c1a8659630a4afa22a55ecec9b66ae0fc0cc53e46cf069e3f599",
        build_file = "@bzlmodrio-photonlib//private/cpp/photontargeting-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photontargeting-cpp_osxuniversal",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2025.0.0-beta-7/photontargeting-cpp-v2025.0.0-beta-7-osxuniversal.zip",
        sha256 = "1f74c87788f280d3dc2888a0a7cb563df018171d4084848b71fd4529b753b645",
        build_file = "@bzlmodrio-photonlib//private/cpp/photontargeting-cpp:shared.BUILD.bazel",
        patch_cmds = [
