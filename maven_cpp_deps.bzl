...
def __setup_bzlmodrio_photonlib_cpp_dependencies(mctx):
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2026.3.4/photonlib-cpp-v2026.3.4-headers.zip",
        sha256 = "dab5f533688773a37d69b18901c1d48d04195e1b448ad94beab821fdf5dd11df",
        build_file_content = cc_library_headers,
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photonlib-cpp_windowsx86-64",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2026.3.4/photonlib-cpp-v2026.3.4-windowsx86-64.zip",
        sha256 = "6424cf27e008b31e4beff851015669aa35600740100ff4a85502717e9a3d8ea9",
    ...
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2026.3.4/photonlib-cpp-v2026.3.4-linuxathena.zip",
        sha256 = "d378296de50232bebaea8554fb5e5047bcd2d40470d14a7950f4208e0904c71a",
        build_file = "@bzlmodrio-photonlib//private/cpp/photonlib-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photonlib-cpp_linuxx86-64",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2026.3.4/photonlib-cpp-v2026.3.4-linuxx86-64.zip",
        sha256 = "22240cc3553232b16c40920bfd580cd5f2568c8ad29f565743a711ad04f0a04f",
        build_file = "@bzlmodrio-photonlib//private/cpp/photonlib-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photonlib-cpp_osxuniversal",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-cpp/v2026.3.4/photonlib-cpp-v2026.3.4-osxuniversal.zip",
        sha256 = "51e2bf2d7b923373c73725973bc57d206d5f720392d5326cfa63c5817a31c0eb",
        build_file = "@bzlmodrio-photonlib//private/cpp/photonlib-cpp:shared.BUILD.bazel",
        patch_cmds = [
    ...
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2026.3.4/photontargeting-cpp-v2026.3.4-headers.zip",
        sha256 = "9628194d79e1ad45c599b480bcbc51ec650a25dbfcfaaed88ab858cb15e0f490",
        build_file_content = cc_library_headers,
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photontargeting-cpp_windowsx86-64",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2026.3.4/photontargeting-cpp-v2026.3.4-windowsx86-64.zip",
        sha256 = "22ce9a53cc348df1879b1151c03b916c7e326e341b39a11feb9400f7975951f3",
    ...
    maybe(
        ...
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2026.3.4/photontargeting-cpp-v2026.3.4-linuxathena.zip",
        sha256 = "1c9e874fb7976fe06b461dd51a695175c488b60fa16d8a6aa84467c38205adc6",
        build_file = "@bzlmodrio-photonlib//private/cpp/photontargeting-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photontargeting-cpp_linuxx86-64",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2026.3.4/photontargeting-cpp-v2026.3.4-linuxx86-64.zip",
        sha256 = "13f3ec5ad0c2dd5bc6b0656bfa57ca8ce3f2d6571077f5042a4a92377cea96b8",
        build_file = "@bzlmodrio-photonlib//private/cpp/photontargeting-cpp:shared.BUILD.bazel",
    )
    maybe(
        http_archive,
        "bazelrio_org_photonvision_photontargeting-cpp_osxuniversal",
        url = "https://maven.photonvision.org/repository/internal/org/photonvision/photontargeting-cpp/v2026.3.4/photontargeting-cpp-v2026.3.4-osxuniversal.zip",
        sha256 = "5be1135ed75de2f43a672304d3291079a328c62f9d983c54e48a6f9d46c5e83e",
        build_file = "@bzlmodrio-photonlib//private/cpp/photontargeting-cpp:shared.BUILD.bazel",
        patch_cmds = [
